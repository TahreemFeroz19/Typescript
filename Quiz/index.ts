...
async function Welcome() {
    const title: chalkAnimation.Animation = chalkAnimation.rainbow(
      figlet.textSync("Typescript      Quiz", {
        font: "Big Money-se",
...
async function startQuiz(questions: IData[]) {
    ...
    for (let i = 0; i < questions.length; i++) {
        ...
        if (questions[i].code) {
            console.log(chalk.bgRgb(1, 21, 26).gray(`________________CODE:________________`))
            ...
            console.log(chalk.bgRgb(1, 21, 26).gray(`_____________________________________`))
        }
