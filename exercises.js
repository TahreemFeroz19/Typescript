...
let places_in_order = [...places].sort();
...
const currentUsers = ["John", "Alice", "Bob", "Eve", "Mary"];
// List of new usernames
const newUsers = ["Jane", "Bob", "David", "EVE", "Kate"];
...
const originalMagicianNames = magician_names.slice();
